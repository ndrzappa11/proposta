<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="API.API_2" import="API.API_5" import="java.sql.Connection"
...
<body>
	...
	int k = prova.numPolizze(user.getIdU(user), conn);%>
	<%=k%>
	<%
	...
	<form name="form assistenza" action="ManagementServlet" method="post">
		<table>
			...
			<tr>
				<td><br><input name="whatsend" value="pagamenti" type="hidden">
					<input name="api" value="<%=api[i]%>" type="hidden"> <input
					type="submit" value="PAGAMENTI"></td>
